---
name: selfreview
description: Post-edit cleanup pass — three specialist agents review recent changes for reuse, quality, and efficiency, then fix issues directly. Use when the user says "/selfreview", "/skill:selfreview", or asks for a self-review cleanup pass.
---
...
When invoked as a slash skill, treat any text following `/skill:selfreview` as optional extra context or a scope hint.
