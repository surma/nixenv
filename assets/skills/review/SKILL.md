---
name: review
description: Multi-model review swarm with TLA validation and deduplication. Use when the user says "/review", "/skill:review", or asks for a multi-model review swarm of code, files, or context.
---

# /review

Review the code, files, or context supplied by the user. When invoked as a slash skill, treat any text following `/skill:review` as the review scope or extra context.
