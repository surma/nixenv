...

{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/ee753eb5-d343-4f16-a1b0-b4c0e0b86a07";
    fsType = "ext4";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/23AE-02E9";
    fsType = "vfat";
    options = [
      "fmask=0077"
      "dmask=0077"
  ...
  swapDevices = [
    { device = "/dev/disk/by-uuid/5734b782-69c5-4183-8f40-fc6cfb4d2bac"; }
  ];
